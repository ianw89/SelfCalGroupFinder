...
class DESI_KCorrection(object):
    def __init__(self, band, kind="cubic", file='jmext', photsys=None):
        ...
        if file == 'ajs':
            ...
            k_corr_file = raw_dir + '/jmext_kcorr_{}_{}band_z01.txt'.format(photsys.upper(), band.lower())
            
        elif file == 'jmextcol':
            # WARNING: These are the colour polynomials.
            # TODO: separate this to avoid ambiguity.
            k_corr_file = raw_dir + '/jmextcol_kcorr_{}_{}band_z01.txt'.format(photsys.upper(), band.lower())
