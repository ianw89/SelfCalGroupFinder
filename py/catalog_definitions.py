...
bgs_y1_pzp_2_4 = BGSGroupCatalog("BGS Y1 PZP v2.4 Vanilla", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, data_cut='Y1-Iron', extra_params=PZP_PARAMS_V24)
_cat = bgs_y1_pzp_2_4
_cat.marker = '-'
_cat.color = 'darkgreen'
_cat.GF_props = GF_PROPS_BGS_VANILLA.copy()

bgs_y1_pzp_2_4_c1 = BGSGroupCatalog("BGS Y1 PZP v2.4 C1", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, data_cut='Y1-Iron', extra_params=PZP_PARAMS_V24)
_cat = bgs_y1_pzp_2_4_c1
_cat.marker = '--'
_cat.color = 'darkgreen'
_cat.GF_props = GF_PROPS_BGS_COLORS.copy()

bgs_y3_pzp_2_4 = BGSGroupCatalog("BGS Y3 PZP v2.4 Vanilla", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, data_cut='Y3-Loa', extra_params=PZP_PARAMS_V24)
...
bgs_y3_pzp_2_4_c1 = BGSGroupCatalog("BGS Y3 PZP v2.4 C1", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, data_cut='Y3-Loa', extra_params=PZP_PARAMS_V24)
...
bgs_y3_fiberonly = BGSGroupCatalog("Observed BGS Y3 <19.5", Mode.FIBER_ASSIGNED_ONLY, 19.5, 21.0, data_cut='Y3-Loa')
_cat = bgs_y3_fiberonly
_cat.marker = '-'
_cat.GF_props = GF_PROPS_BGS_VANILLA.copy()

bgs_y3_fiberonly_1pass = BGSGroupCatalog("Observed BGS Y3 <19.5 1pass", Mode.FIBER_ASSIGNED_ONLY, 19.5, 21.0, num_passes=1, data_cut='Y3-Loa')
...
bgs_sv3_pz_1_10p.GF_props = GF_PROPS_BGS_VANILLA.copy()
bgs_sv3_pz_1_10p.color = [0.0, 1.0, 1.0]

bgs_sv3_pz_2_4_10p = BGSGroupCatalog("Photo-z Plus v2.4 BGS sv3 10pass", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=10, data_cut='sv3', sdss_fill=True, extra_params=PZP_PARAMS_V24)
bgs_sv3_pz_2_4_10p.GF_props = GF_PROPS_BGS_VANILLA.copy()
bgs_sv3_pz_2_4_10p.color = 'k'

bgs_sv3_pz_2_4_10p_c1 = BGSGroupCatalog("Photo-z Plus v2.4 BGS sv3 10pass C1", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=10, data_cut='sv3', sdss_fill=True, extra_params=PZP_PARAMS_V24)
bgs_sv3_pz_2_4_10p_c1.GF_props = GF_PROPS_BGS_COLORS.copy()
bgs_sv3_pz_2_4_10p_c1.color = 'k'

bgs_sv3_10p_mcmc = BGSGroupCatalog("BGS SV3 PZPv2.4 10pass MCMC", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=10, data_cut='sv3', sdss_fill=True, extra_params=PZP_PARAMS_V24)
...
bgs_sv3_pz_2_4_10p_old = BGSGroupCatalog("Photo-z Plus v2.4 BGS sv3 10pass OLD", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=10, data_cut='sv3', sdss_fill=True, extra_params=PZP_PARAMS_V24)
bgs_sv3_pz_2_4_10p_old.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_pz_1_0_7p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_pz_2_0_7p.GF_props = GF_PROPS_BGS_VANILLA.copy()
bgs_sv3_pz_2_0_7p.color ='red'

bgs_sv3_pz_2_4_8p = BGSGroupCatalog("Photo-z Plus v2.4 BGS sv3 8pass ", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=10, drop_passes=2, data_cut='sv3', sdss_fill=False, extra_params=PZP_PARAMS_V24)
bgs_sv3_pz_2_4_8p.GF_props = GF_PROPS_BGS_VANILLA.copy()
bgs_sv3_pz_2_4_8p.color ='orange'

bgs_sv3_pz_2_4_7p = BGSGroupCatalog("Photo-z Plus v2.4 BGS sv3 7pass ", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=10, drop_passes=3, data_cut='sv3', sdss_fill=False, extra_params=PZP_PARAMS_V24)
bgs_sv3_pz_2_4_7p.GF_props = GF_PROPS_BGS_VANILLA.copy()
bgs_sv3_pz_2_4_7p.color ='darkorange'

bgs_sv3_pz_2_4_6p = BGSGroupCatalog("Photo-z Plus v2.4 BGS sv3 6pass ", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=10, drop_passes=4, data_cut='sv3', sdss_fill=False, extra_params=PZP_PARAMS_V24)
bgs_sv3_pz_2_4_6p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_pz_3_0_7p.GF_props = GF_PROPS_BGS_VANILLA.copy()
bgs_sv3_pz_3_0_7p.color = [0.45, 0.40, 0.0]

bgs_sv3_pz_3_1_7p = BGSGroupCatalog("Photo-z Plus v3.1 BGS sv3 7pass ", Mode.PHOTOZ_PLUS_v3, 19.5, 21.0, num_passes=10, drop_passes=3, data_cut='sv3', sdss_fill=False, extra_params= PZP_PARAMS_V24)
bgs_sv3_pz_3_1_7p.GF_props = GF_PROPS_BGS_VANILLA.copy()
bgs_sv3_pz_3_1_7p.color = 'purple'

bgs_y3_like_sv3_pz_2_4 = BGSGroupCatalog("Photo-z Plus v2.4 BGS Y3 like-sv3", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=1, data_cut='Y3-Loa-SV3Cut', sdss_fill=False, extra_params= PZP_PARAMS_V24)
bgs_y3_like_sv3_pz_2_4.GF_props = GF_PROPS_BGS_VANILLA.copy()
bgs_y3_like_sv3_pz_2_4.color ='slateblue'

bgs_y3_like_sv3_pz_2_4_c1 = BGSGroupCatalog("Photo-z Plus v2.4 BGS Y3 like-sv3 C1", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=1, data_cut='Y3-Loa-SV3Cut', sdss_fill=False, extra_params= PZP_PARAMS_V24)
bgs_y3_like_sv3_pz_2_4_c1.GF_props = GF_PROPS_BGS_COLORS.copy()
bgs_y3_like_sv3_pz_2_4_c1.color ='slateblue'

bgs_y3_like_sv3_pz_2_5 = BGSGroupCatalog("Photo-z Plus v2.5 BGS Y3 like-sv3", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=1, data_cut='Y3-Loa-SV3Cut', sdss_fill=False, extra_params=
...
bgs_y3_like_sv3_fiberonly = BGSGroupCatalog("Observed BGS Y3 like-sv3", Mode.FIBER_ASSIGNED_ONLY, 19.5, 21.0, num_passes=1, data_cut='Y3-Loa-SV3Cut', sdss_fill=False)
bgs_y3_like_sv3_fiberonly.GF_props = GF_PROPS_BGS_VANILLA.copy()
bgs_y3_like_sv3_fiberonly.color ='orange'

bgs_y3_like_sv3_pz_2_0 = BGSGroupCatalog("Photo-z Plus v2.0 BGS Y3 like-sv3", Mode.PHOTOZ_PLUS_v2, 19.5, 21.0, num_passes=1, data_cut='Y3-Loa-SV3Cut', sdss_fill=False, extra_params=(1, [0.0, 0.0, 3.0]))
bgs_y3_like_sv3_pz_2_0.GF_props = GF_PROPS_BGS_VANILLA.copy()
bgs_y3_like_sv3_pz_2_0.color ='red'

bgs_y3_like_sv3_nn = BGSGroupCatalog("Nearest Neighbor BGS Y3 like-sv3", Mode.NEAREST_NEIGHBOR, 19.5, 21.0, num_passes=1, data_cut='Y3-Loa-SV3Cut', sdss_fill=False)
bgs_y3_like_sv3_nn.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_fiberonly_10p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_4_10p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_4_9p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_4_8p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_4_7p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_4_6p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_4_5p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_4_4p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_4_3p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_4_2p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_4_1p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_nn_10p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_nn_7p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_nn_6p.GF_props = GF_PROPS_BGS_VANILLA.copy()
...
bgs_sv3_simple_5_7p.GF_props = GF_PROPS_BGS_VANILLA.copy()
