...
def process_gc(gc: GroupCatalog):
    ...
    if execution_mode == 'once':
        ...
        if name == "BGS Y1 Hybrid8 v1 MCMC":
            backend_file = f"/mount/sirocco1/imw2293/GROUP_CAT/OUTPUT/BGS_Y1_HYBRID8_V1_MCMC_BACKUP/mcmc_{mcmcnum}/gf_mcmc.h5"
            previous_backend = emcee.backends.HDFBackend(backend_file, read_only=True)
