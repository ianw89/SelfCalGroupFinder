...
PAPER_PLOT_FOLDER = OUTPUT_FOLDER + 'A_PAPER_PLOTS/' # DR 1 Paper folder
...
WP_RADIAL_BINS_DESI_FILE = PARAMS_BGSY1_FOLDER + 'wp_rbins.dat'
WP_RADIAL_EDGE_DESI_FILE = PARAMS_BGSY1_FOLDER + 'wp_redges.dat'
HMF_T08_BOL_FILE = PARAMS_SDSS_FOLDER + 'hmf_t08_bolshoi.dat'
HMF_T08_P18_FILE = PARAMS_BGSY1_FOLDER + 'hmf_t08_p18.dat'
LSAT_LOOKUP_FILE = REPO_FOLDER + 'lsat_lookup.dat'
LSAT_OBSERVATIONS_FILE = 'Lsat_obs_to_use.dat'
LSAT_OBSERVATIONS_SDSS_FILE = PARAMS_SDSS_FOLDER + 'Lsat_SDSS_DnGMM.dat'
LSAT_OBSERVATIONS_SDSS_TRANSFORMED_FILE = PARAMS_BGSY1_FOLDER + 'Lsat_SDSS_DnGMM_MagTransformed.dat'
...
IAN_BGS_SV3_MERGED_FULL_FILE = BGS_FUJI_FOLDER + "ian_BGS_SV3_merged_full.fits"
...
NEIGHBOR_ANALYSIS_SV3_BINS_FILE_V2 = OUTPUT_FOLDER + 'BGS_cic_binned_data_v2.pkl'
NEIGHBOR_ANALYSIS_SV3_BINS_SMOOTHED_FILE_V2 = OUTPUT_FOLDER + 'BGS_cic_smoothed_binned_data_v2.pkl'
...
BGS_Y3_KCORR_LOOKUP_FILE = BGS_Y3_FOLDER_LOA + "bgsy3_kcorr_lookup.pkl"
