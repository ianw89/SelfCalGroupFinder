# DESI SV3 BGS Galaxy Group Catalog


## Internal Version Note
This folder contains a (presently) INTERNAL galaxy group catalog built from DESI SV3 Bright Galaxy Survey ('FUJI' reductions). Please get in touch with the authors if you are using this for DESI science. It is not intended for public release.
