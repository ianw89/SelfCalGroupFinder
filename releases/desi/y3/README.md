...
- **ABS_MAG_R (float64)**: absolute magnitude in r-band, k-corrected to z=0.1, with H=100.- **VMAX (float64)**: max volume this galaxy could be observed in based on L_GAL; intended for 1/VMAX corrections for this flux-limited sample.
