...
This folder contains a (presently) INTERNAL galaxy group catalog built from DESI DR2 Bright Galaxy Survey ('LOA' reductions). Please get in touch with the authors if you are using this for DESI science. It is intended for public release.
