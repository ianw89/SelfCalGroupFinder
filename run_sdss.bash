...
# No colors or chi
bin/kdGroupFinder_omp data/sdss_fluxlim_v1.0.dat $zmin $zmax $frac_area $fluxlim $color $omegaL_sf $sigma_sf $omegaL_q $sigma_q 0 0 10 0 10 0 > bin/sdss_ian_1.out
